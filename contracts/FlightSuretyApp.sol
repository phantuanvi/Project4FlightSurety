...
contract FlightSuretyApp {
     ...
     *
     */
    function handleInsureesOfFlight(
        address airline,
    ...
    function submitOracleResponse(
        ...
        if (
            ...
            handleInsureesOfFlight(airline, flight, timestamp, statusCode);
        }
    }
